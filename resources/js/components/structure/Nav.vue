        ...
        <header class="header-global">
            <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
                <div class="container">
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                        <div v-if="!isLogedIn" class="navbar-nav align-items-lg-center ml-lg-auto">
                            <li class="nav-item">
                        ...
                        <div v-else-if="isLogedIn">
                            <li class="nav-item">
                                
                                <button @click="logOut" class="btn btn-outline-default">Log out</button>
                            </li>
                        </div>
                    </ul>
                    </div>
